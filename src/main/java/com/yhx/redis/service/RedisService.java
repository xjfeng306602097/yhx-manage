...
public class RedisService {
	 ...
	 * @return
	 */
	public boolean putCache(final String key, final Object obj, Long timeout) {
		try {
			if (timeout != null) {
	...
	// ============================String============================= /** * 普通缓存获取
	// * * @param key 键 * @return 值 */ public Object get(String key) { return key ==
	...
	// public Object hget(String key, String item) { return
	...
	public Set<Object> getListBehind(String key) {
